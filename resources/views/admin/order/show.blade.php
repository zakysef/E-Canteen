...
<div class="max-w-3xl">
    ...
    <div class="card p-6 mb-5">
        <div class="flex flex-wrap items-start justify-between gap-4 mb-5">
            ...
            {{-- Status update form (if actionable) --}}
            ...
            <div>
                ...
                <div class="bg-pink-50 rounded-xl p-4 space-y-3">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-sm font-medium text-gray-700">{{ $order->seller->nama_toko ?? $order->seller->name }}</span>
                    </div>
                    @endif
                    @if($order->catatan)
                    <div>
        ...
        @php
            $timestamps = collect([
                ...
                ['label' => 'Disiapkan', 'time' => $order->preparing_at ?? null],
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        ...
                        @if($item->catatan_item ?? null)
                        <p class="text-xs text-gray-400 mt-0.5">{{ $item->catatan_item }}</p>
                        @endif
                    </td>
            ...
            <div class="flex items-center justify-between">
                <div class="space-y-1">
                    <div class="flex items-center gap-8 text-sm text-gray-500">
                        ...
                        <span class="font-medium text-gray-700">{{ $order->items->sum('qty') }} porsi</span>
                    </div>
                </div>
