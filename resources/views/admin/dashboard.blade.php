...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
    ...
    <div class="stat-card">
        ...
        <div class="min-w-0">
            ...
            <p class="text-lg font-bold text-rose-700 truncate">Rp {{ number_format($stats['pendapatan_hari_ini'], 0, ',', '.') }}</p>
        </div>
    </div>
    ...
    <div class="stat-card">
        ...
        <div class="min-w-0">
            ...
            <p class="text-lg font-bold text-pink-700">{{ $stats['pesanan_aktif'] }}</p>
        </div>
    </div>
    ...
    <div class="stat-card">
        ...
        <div class="min-w-0">
            ...
            <p class="text-lg font-bold text-pink-700 truncate">Rp {{ number_format($stats['saldo'], 0, ',', '.') }}</p>
        </div>
    </div>
...
<div class="card mb-8">
    <div class="px-6 py-4 border-b border-pink-100 flex items-center justify-between">
        <div class="flex items-center gap-2">
            <i class="ph ph-clock text-pink-500 text-lg"></i>
            <h3 class="font-semibold text-gray-800">Antrian Pesanan Aktif</h3>
        </div>
        <a href="{{ route('admin.orders.index') }}" class="text-xs text-pink-600 hover:underline font-medium">
            Lihat semua
        </a>
    </div>
        ...
        <table class="data-table w-full">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <span class="font-semibold text-pink-600">Rp {{ number_format($order->total_harga, 0, ',', '.') }}</span>
                    </td>
                    <td>
                    ...
                    <td class="text-right">
                        ...
                        <form method="POST" action="{{ route('admin.orders.status', $order) }}">
                            ...
                            <button type="submit" class="btn-primary btn-sm inline-flex items-center gap-1.5">
...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
    ...
    <a href="{{ route('admin.menu.create') }}"
       class="card p-5 flex flex-col items-center gap-3 text-center hover:border-pink-300 hover:shadow-md transition-all group cursor-pointer">
        <div class="w-12 h-12 rounded-2xl bg-rose-100 text-rose-600 flex items-center justify-center text-2xl group-hover:bg-rose-500 group-hover:text-white transition-colors">
